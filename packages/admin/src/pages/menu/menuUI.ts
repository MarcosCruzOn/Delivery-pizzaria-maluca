	...
	<div class="card mt-3 pl-0">
		<div class="d-flex">
			...
			<div class="container-img-produto" style="background-image:url('${p.imageUrl}');background-size:cover;">
				<a href="#" class="icon-action me-1 mb-1"><i class="fas fa-pencil-alt"></i></a>
			</div>
...
export function renderProductModal(categories: Category[]) {
	return Modal({
		...
		title: 'Novo produto',
		body: `
			<div class="form-group mb-3"><label><b>Nome</b></label><input type="text" class="form-control" id="novoProdutoNome"/></div>
			<div class="form-group mb-3"><label><b>Descrição</b></label><textarea class="form-control" id="novoProdutoDescricao"></textarea></div>
			<div class="form-group mb-3"><label><b>Valor</b></label><input type="number" step="0.01" class="form-control" id="novoProdutoValor"/></div>
			...
			<div class="form-group mb-3"><label><b>Imagem</b></label><input type="file" class="form-control" id="novoProdutoImagem"/></div>
			<img id="previewNovoProduto" style="display:none;width:200px;border-radius:10px"/>
			<div class="form-group mb-3 mt-3"><label><b>Opcionais vinculados</b></label></div>
